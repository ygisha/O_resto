<!-- Code pour afficher les spécialités dans la page d'accueil-->
<?php include('connection.php');
	$msg="";
	if (isset($_GET['id'])){

		$update="SELECT restaurants.id,titre,description,restaurants.image,categories.libelle FROM restaurants 
		INNER JOIN categories ON
		restaurants.id_categories=categories.id
		WHERE restaurants.id_categories=".$_GET['id'];
...
<!--   code html pour la liste des spécialités -->
		<br>
		<div class="container">

			<center>
        		<h1 style="color: #c41200"> Nos cuisines </h1>
	      	</center>
	      	<br>
			<div class="row">
